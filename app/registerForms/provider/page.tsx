...
import LockedRegisterForm, { userType } from "../components/LockedRegisterForm";
import { FaBuilding, FaFileAlt, FaTag } from "react-icons/fa";
import { categories } from "../data";
import { useAuthForms } from "@/auth/hooks/useAuthForms";

export default function RegisterProviderPage({ user }: { user: userType }) {
  const { completeSignUpAsProviderHandler, error } = useAuthForms();
  return (
      ...
      <div className="w-full max-w-2xl">
        <div className="bg-slate-800 rounded-2xl shadow-2xl overflow-hidden border border-slate-700">
          ...
          <div className="p-8 space-y-6">
            <LockedRegisterForm user={user} />
            <form onSubmit={completeSignUpAsProviderHandler}>
