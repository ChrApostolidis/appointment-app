...
const highlights = [
  "24/7 scheduling so bookings happen even when you’re offline",
  "Automatic confirmations, reminders, and follow-up messages",
  "One-click reschedule and cancel",
  "Reduce no-shows with situation-specific email SMS messages",
  "Instantly update your CRM",
  "Appointments that feel effortless for your customers",
];

export default function AutomateEverythingMarketingComponent() {
  return (
    <div className="relative overflow-hidden rounded-3xl border border-primary/10 bg-gradient-to-br from-background via-background to-primary/40 px-6 py-12 shadow-2xl">
      <div
        aria-hidden
      ...
      <div className="relative justify-center flex flex-col items-center gap-10 lg:flex-row lg:items-center">
        ...
        >
          ...
          <p className="text-base text-muted-foreground lg:text-lg">
            Eliminate the back and forth of scheduling so you can spend your
            time where it matters — with customers.
          </p>
          <div className="grid w-full grid-cols-1 gap-4 sm:grid-cols-2">
            {highlights.map((item, idx) => (
              <motion.div
                ...
                transition={{ delay: 0.3 * idx, duration: 0.4 }}
