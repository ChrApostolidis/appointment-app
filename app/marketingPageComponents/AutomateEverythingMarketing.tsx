...
export default function AutomateEverythingMarketingComponent() {
  return (
    <div className="relative overflow-hidden rounded-lg border border-primary/10 bg-gradient-to-br from-background via-background to-primary/40 px-6 py-12 shadow-2xl">
      <div
        aria-hidden
